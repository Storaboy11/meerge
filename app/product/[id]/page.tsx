...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  const handleAddToCartFromModal = () => {
    ...
    if (finalQuantity <= 0 || finalQuantity > product.stockQty) {
      toast({
        title: "Invalid Quantity",
        description: `Please select a quantity between 1 and ${product.stockQty}kg.`,
        variant: "destructive",
      })
      return
    }
    ...
    toast({
      title: "Added to cart",
      description: `${finalQuantity}kg of ${product.name} added to your cart.`,
    })
  ...
  const getModalTotalPrice = () => {
    ...
    return product.pricePerKg * (isNaN(quantity) ? 0 : quantity)
  }
  ...
  if (!product && error) {
    return (
      <div className="min-h-screen bg-background">
        <DashboardNavbar selectedLocation={selectedLocation} cartItemCount={getTotalCartItems()} onSearch={() => {}} />
        <div className="max-w-6xl mx-auto px-4 py-8">
          <Card>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-baseline space-x-2 mb-4">
                <span className="text-3xl font-bold text-primary">₦{product.pricePerKg.toLocaleString()}</span>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              <p className="text-sm font-medium text-green-900">Stock Available</p>
              <p className="text-sm text-green-700">{product.stockQty} kg in stock</p>
            </div>

            <Button onClick={handleAddToCartClick} className="w-full h-12 text-base font-semibold" size="lg">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">₦{product.pricePerKg.toLocaleString()}/kg</p>
                </div>
              </div>

              {/* Quantity Options */}
              <div>
                <Label className="text-sm font-medium mb-3 block">Select Quantity (kg)</Label>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-medium">{customQuantity || selectedQuantity}kg</span>
                </div>
